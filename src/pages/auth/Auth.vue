<template>
  <q-page class="column justify-center q-pa-lg" style="max-width: 400px;margin: 0 auto">
...
<!--      <div class="text-caption text-grey">{{ server ? '' : 'local' }} v{{ version }}</div>-->
      <q-btn label="利用規約等" flat :to="{ name: 'tos' }"/>
    </div>
  </q-page>
</template>
